...
AWS_FINE_TUNED_BERT_MODEL = "fine_tuned_bert_model.pth"
AWS_FINE_TUNED_FASTVIT_MODEL = "fine_tuned_fastvit_model.pth"
AWS_MLP_MODEL = "mlp_model.pth"
...
AWS_TARGET_SCALER = "target_scaler.pkl"

FINE_TUNED_BERT_MODEL = Path(PARENT_DIR_PATH + AWS_MODELS_FOLDER + AWS_FINE_TUNED_BERT_MODEL)
FINE_TUNED_FASTVIT_MODEL = Path(PARENT_DIR_PATH + AWS_MODELS_FOLDER + AWS_FINE_TUNED_FASTVIT_MODEL)
...
TARGET_SCALER = Path(PARENT_DIR_PATH + AWS_PREPROCESSORS_FOLDER + AWS_TARGET_SCALER)
