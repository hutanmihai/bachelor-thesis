...
S3_DIR_PATH = os.path.join(os.getcwd(), "s3")
...
FINE_TUNED_BERT_MODEL = Path(S3_DIR_PATH + AWS_MODELS_FOLDER + AWS_FINE_TUNED_BERT_MODEL)
MULTIMODAL_ENCODER_MODEL = Path(S3_DIR_PATH + AWS_MODELS_FOLDER + AWS_MULTIMODAL_ENCODER_MODEL)
MULTIMODAL_MODEL = Path(S3_DIR_PATH + AWS_MODELS_FOLDER + AWS_MULTIMODAL_MODEL)
SCALER_NUMERICAL = Path(S3_DIR_PATH + AWS_PREPROCESSORS_FOLDER + AWS_SCALER_NUMERICAL)
SCALER_CATEGORICAL = Path(S3_DIR_PATH + AWS_PREPROCESSORS_FOLDER + AWS_SCALER_CATEGORICAL)
ENCODER = Path(S3_DIR_PATH + AWS_PREPROCESSORS_FOLDER + AWS_ENCODER)
